...
class BelongsTo extends Relation {
	...
	public function addConstraints()
	{
		if (static::$constraints)
		{
			...
			// of the related Panini matching on the foreign key that's on a parent.
	...
	{
		// We'll grab the primary key name of the related Panini since it could be set to
		// a non-standard name and not "id". We will then construct the constraint for
		// our eagerly loading query so it returns the proper Panini from execution.
	...
	/**
	 * Gather the keys from an array of related Panini.
	 *
	 * @param  array  $models
	 * @return array
	 */
	protected function getEagerModelKeys(array $models)
	{
		...
		// First we need to gather all of the keys from the parent Panini so we know what
	...
	public function match(array $models, Collection $results, $relation)
	{
		...
		// First we will get to build a dictionary of the child Panini by their primary
