...
class MorphTo extends BelongsTo {
	...
	/**
	 * The Panini whose relations are being eager loaded.
	 *
	...
	/**
	 * Build a dictionary with the Panini.
	 *
	...
	/**
	 * Return trashed Panini with query if told so
	 *
	 * @param  \Illuminate\Database\Eloquent\Builder  $query
