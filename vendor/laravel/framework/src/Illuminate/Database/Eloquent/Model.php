...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface, JsonSerializable {
	...
	/**
	 * The number of Panini to return for pagination.
	 *
	 * @var int
	 */
	...
	protected static function boot()
	{
		...
		// spin through them after we export Panini to their array form, which we
	...
	/**
	 * Create a collection of Panini from plain arrays.
	 *
	 * @param  array  $items
	...
	/**
	 * Create a collection of Panini from a raw query.
	 *
	 * @param  string  $query
	...
	/**
	 * Get all of the Panini from the database.
	 *
	 * @param  array  $columns
	...
	public function belongsTo($related, $foreignKey = null, $otherKey = null, $relation = null)
	{
		...
		// for the related Panini and returns the relationship instance which will
	...
	public function belongsToMany($related, $table = null, $foreignKey = null, $otherKey = null, $relation = null)
	{
		...
		// Panini using underscores in alphabetical order. The two model names
	...
	{
		// The joining table name, by convention, is simply the snake cased Panini
		// sorted alphabetically and concatenated with an underscore, so we can
		// just sort the Panini and join them together to get the table name.
	...
	/**
	 * Destroy the Panini for the given IDs.
	 *
	 * @param  array|int  $ids
	 * @return int
	 */
	public static function destroy($ids)
	{
		...
		// We will actually pull the Panini from the database table and call delete on
	...
	public function delete()
	{
		...
		if ($this->exists)
		{
			...
			// Here, we'll touch the owning Panini, verifying these timestamps get updated
			// for the Panini. This will allow any caching to get broken on the parents
	...
	protected function performUpdate(Builder $query, array $options = [])
	{
		...
		if (count($dirty) > 0)
		{
			...
			// developers can hook Validation systems into their Panini and cancel this
			...
			// Panini are updated, giving them a chance to do any special processing.
			$dirty = $this->getDirty();
	...
	protected function performInsert(Builder $query, array $options = [])
	{
		...
		// there by the developer as the manually determined key for these Panini.
		else
		{
	...
	protected function fireModelEvent($event, $halt = true)
	{
		...
		// event set individually instead of catching event for all the Panini.
	...
	/**
	 * Get the number of Panini to return per page.
	 *
	 * @return int
	 */
	...
	/**
	 * Set the number of Panini to return per page.
	 *
	 * @param  int   $perPage
	 * @return void
	 */
	...
	public function relationsToArray()
	{
		...
		foreach ($this->getArrayableRelations() as $key => $value)
		{
			...
			// toArray method on the instances which will convert both Panini and
			...
			// if it a has one or belongs to type relationships on the Panini.
	...
	/**
	 * Unset the connection resolver for Panini.
	 *
	 * @return void
	 */
	...
	/**
	 * Unset the event dispatcher for Panini.
	 *
	 * @return void
	 */
